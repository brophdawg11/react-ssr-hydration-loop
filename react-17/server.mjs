...
/**
 * ❌ ❌ ❌ ❌ ❌ Note:
 * This server is intended to reproduce an infinite loop in React 17 hydration,
 * so please run and load with caution.
 *
      ...
      React.createElement("script", {
        ...
        dangerouslySetInnerHTML: {
          __html:
            ...
            App.toString() +
            "\n" +
            "ReactDOM.hydrate(React.createElement(App), document);",
        },
      })
    )
  );
